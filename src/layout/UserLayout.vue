  ...
  <main>
    ...
    <button v-if="isVisible" @click="scrollToTop"
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white"
        stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-to-line">
        <path d="M5 3h14" />
        ...
        <div class="w-full lg:w-auto">
          ...
          <div class="flex justify-center lg:justify-start gap-4">
            ...
            <a href="https://github.com/Chanchai-Heart" target="_blank">
              <svg class="w-10 h-10 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                <path
            ...
            <a href="https://www.linkedin.com/in/chanchai-janhom-26409a322/" target="_blank">
              <svg class="w-10 h-10 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path
